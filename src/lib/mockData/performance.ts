...
const CLIENT_RETURNS: Record<string, number[]> = {
...
function buildPerformance(clientId: string): PerformanceData {
...
export const MOCK_PERFORMANCE: Record<string, PerformanceData> = {
