...
import { LOGIN_STRINGS, FEATURE_BULLETS, DEMO_STATS, APP } from '@/constants/strings';
  ...
  return (
    <div className="min-h-screen flex bg-slate-50 dark:bg-slate-900">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-gradient-to-br from-blue-700 via-blue-600 to-indigo-800 flex-col justify-between p-10">
        ...
        {/* Ambient blobs */}
        <div className="absolute -top-24 -left-24 w-72 h-72 rounded-full bg-white/5 blur-3xl animate-pulse" style={{ animationDuration: ANIMATION.BLOB_1_DURATION }} />
        <div className="absolute bottom-10 -right-16 w-96 h-96 rounded-full bg-indigo-400/10 blur-3xl animate-pulse" style={{ animationDuration: ANIMATION.BLOB_2_DURATION, animationDelay: ANIMATION.BLOB_2_DELAY }} />
        <div className="absolute top-1/2 left-1/3 w-48 h-48 rounded-full bg-blue-300/10 blur-2xl animate-pulse" style={{ animationDuration: ANIMATION.BLOB_3_DURATION, animationDelay: ANIMATION.BLOB_3_DELAY }} />
