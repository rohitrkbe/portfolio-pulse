...
describe('generateRebalancingRecommendations', () => {
  const basePortfolio: MockPortfolioData = {
    ...
    holdings: [
      { id: 'h001', instrumentName: 'Reliance Industries', ticker: 'RELIANCE', assetClass: 'Equities', currentValue: 4_200_000, gainLossAbs: 0, gainLossPct: 0, weightPct: 42 },
      { id: 'h002', instrumentName: 'TCS',                 ticker: 'TCS',      assetClass: 'Equities', currentValue: 2_500_000, gainLossAbs: 0, gainLossPct: 0, weightPct: 25 },
    ],
  };
  ...
  it('generates BUY recommendations for underweight classes with existing holdings', () => {
    const portfolio: MockPortfolioData = {
      ...
      holdings: [
        { id: 'h001', instrumentName: 'GOI Bond', ticker: 'GOIBOND', assetClass: 'Debt', currentValue: 1_800_000, gainLossAbs: 0, gainLossPct: 0, weightPct: 18 },
        { id: 'h002', instrumentName: 'Reliance', ticker: 'RELIANCE', assetClass: 'Equities', currentValue: 7_200_000, gainLossAbs: 0, gainLossPct: 0, weightPct: 72 },
      ],
    };
  ...
  it('generates a fallback index fund BUY when class has no holdings', () => {
    const portfolio: MockPortfolioData = {
      ...
      holdings: [
        { id: 'h001', instrumentName: 'Reliance', ticker: 'RELIANCE', assetClass: 'Equities', currentValue: 8_000_000, gainLossAbs: 0, gainLossPct: 0, weightPct: 80 },
      ],
    };
    const recs = generateRebalancingRecommendations(portfolio);
  ...
  it('splits evenly across equal-valued holdings', () => {
    const portfolio: MockPortfolioData = {
      ...basePortfolio,
      holdings: [
        { id: 'h001', instrumentName: 'Stock A', ticker: 'A', assetClass: 'Equities', currentValue: 3_350_000, gainLossAbs: 0, gainLossPct: 0, weightPct: 33.5 },
        { id: 'h002', instrumentName: 'Stock B', ticker: 'B', assetClass: 'Equities', currentValue: 3_350_000, gainLossAbs: 0, gainLossPct: 0, weightPct: 33.5 },
      ],
    };
    const recs = generateRebalancingRecommendations(portfolio);
