...
export const FEATURE_BULLETS: string[] = [
...
export const PORTFOLIO_STRINGS = {
  ...
  HOLDINGS_SUBTITLE: (n: number) => `${n} instruments across all asset classes`,
  ...
  DRIFT_HEADER: (n: number) => `Drift Analysis — ${n} class${n > 1 ? 'es' : ''} out of tolerance`,
